...
export function LanguageStats() {
    ...
    const fetchLanguageStats = async () => {
        ...
        try {
            ...
            const languageTotals = languages.reduce((acc: Record<string, number>, curr) => {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Language Distribution</CardTitle>
                <CardDescription>Top 5 most used languages across your repositories</CardDescription>
            </CardHeader>
            <CardContent>
                {loading ? (
                    ...
                    <ChartContainer config={chartConfig}>
                        ...
                        >
                            ...
                            <ChartTooltip
                                ...
                                content={
                                    <ChartTooltipContent
                                        valueFormatter={(value) => `${(value / 1000).toFixed(1)}K bytes`}
                                    />
                                }
                            />
                            <Bar
